...
└── rules/
    ...
    │   ├── 02-token-efficiency.mdc                 # 비용·토큰 절약 규칙
    │   └── 03-skill-and-reference-governance.mdc   # 외부 Skill·레퍼런스·MDC 생성 거버넌스
    ├── architecture/
    │   ├── code-structure.mdc                      # 모듈·폴더·명명 규칙
    │   ├── data-integrity.mdc                      # DB·API·연동 보호
    │   └── testing-quality.mdc                     # 테스트·검증 기준
    ├── design/
    ...
    └── project/
        └── project-context.mdc                     # 프로젝트별 기술·업무 맥락
